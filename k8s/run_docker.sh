...
CMD="docker run -p 80:80 -e CALLBACK_TOKEN=xyztoken -e K8S_TOKEN="${K8S_TOKEN}" -e HOST_ACCESS_IP=10.0.1.1 -e K8S_USER='microadmin' -e K8S_USER_PASS='\$apr1\$029KDYcF\$OWgQy3KmUTum5je0T1Ooi1' sastix/microdash:1.0${1}"
echo $CMD
